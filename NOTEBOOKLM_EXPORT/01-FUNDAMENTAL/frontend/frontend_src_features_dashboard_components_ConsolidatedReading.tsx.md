# ConsolidatedReading.tsx

## Visão geral
- Caminho original: `frontend/src/features/dashboard/components/ConsolidatedReading.tsx`
- Domínio: **frontend**
...
## Resumo factual
Este arquivo foi classificado como feature-component no domínio frontend. Criticidade: important. Prioridade: 01-FUNDAMENTAL. Exports detectados: ConsolidatedReading. Funções/classes detectadas: ConsolidatedReading. Dependências externas detectadas: react. Indícios de framework/arquitetura: react/tsx, client-component.
