...
## Visão geral
- Caminho original: `frontend/docs/architecture.md`
- Domínio: **shared**
...
## Resumo factual
Este arquivo foi classificado como source-file no domínio shared. Criticidade: supporting. Prioridade: 03-SUPPORTING. Temas relevantes detectados: calls, firebase, hubspot, insights, sdr, team, upload, webhook. Indícios de framework/arquitetura: firebase.
