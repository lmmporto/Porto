...
## Visão geral
- Caminho original: `frontend/tailwind.config.ts`
- Domínio: **shared**
...
## Resumo factual
Este arquivo foi classificado como source-file no domínio shared. Criticidade: supporting. Prioridade: 03-SUPPORTING. Dependências externas detectadas: tailwindcss, tailwindcss-animate. Temas relevantes detectados: token.
