...
## Visão geral
- Caminho original: `frontend/src/components/dashboard/SDRRanking.tsx`
- Domínio: **frontend**
...
- Funções/classes detectadas: **4**

## Resumo factual
Este arquivo foi classificado como component no domínio frontend. Criticidade: important. Prioridade: 02-HIGH-VALUE. Exports detectados: SDRRanking. Funções/classes detectadas: SDRRanking, getScoreColor, getStatusIcon, handleSdrClick. Dependências locais detectadas: @/context/CallContext, @/lib/utils, @/types. Dependências externas detectadas: lucide-react, react. Temas relevantes detectados: calls, dashboard, email, ranking, sdr, stats, summary. Indícios de framework/arquitetura: react/tsx, client-component.
