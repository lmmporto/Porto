...
## Visão geral
- Caminho original: `frontend/src/components/dashboard/TeamCard.tsx`
- Domínio: **frontend**
...
## Resumo factual
Este arquivo foi classificado como component no domínio frontend. Criticidade: important. Prioridade: 02-HIGH-VALUE. Exports detectados: TeamCard. Funções/classes detectadas: TeamCard. Dependências locais detectadas: @/components/ui/badge, @/components/ui/card, @/lib/metrics, @/types. Dependências externas detectadas: lucide-react. Temas relevantes detectados: calls, metrics, sdr, team. Indícios de framework/arquitetura: react/tsx, client-component.
