...
## Visão geral
- Caminho original: `frontend/src/app/login/page.tsx`
- Domínio: **frontend**
...
## Resumo factual
Este arquivo foi classificado como page no domínio frontend. Criticidade: important. Prioridade: 02-HIGH-VALUE. Exports detectados: LoginPage, function. Funções/classes detectadas: LoginPage, handleGoogleLogin. Dependências locais detectadas: @/components/ui/button, @/components/ui/card, @/components/ui/nibo-logo. Variáveis de ambiente detectadas: NEXT_PUBLIC_API_BASE_URL, NEXT_PUBLIC_API_URL. Temas relevantes detectados: auth, sdr. Indícios de framework/arquitetura: react/tsx, next-app-router, client-component.
