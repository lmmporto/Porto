...
## Visão geral
- Caminho original: `frontend/src/components/layout/header.tsx`
- Domínio: **frontend**
...
## Resumo factual
Este arquivo foi classificado como component no domínio frontend. Criticidade: important. Prioridade: 02-HIGH-VALUE. Exports detectados: Header. Funções/classes detectadas: Header. Dependências locais detectadas: @/context/DashboardContext, @/lib/firebase. Dependências externas detectadas: firebase/firestore, react. Temas relevantes detectados: admin, dashboard, email, firebase, sdr. Indícios de framework/arquitetura: react/tsx, client-component, firebase.
