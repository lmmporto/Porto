...
## Visão geral
- Caminho original: `frontend/src/app/dashboard/upload/page.tsx`
- Domínio: **frontend**
...
- Linhas: **108**
- Imports detectados: **9**
- Exports detectados: **2**
- Funções/classes detectadas: **2**

## Resumo factual
Este arquivo foi classificado como page no domínio frontend. Criticidade: important. Prioridade: 02-HIGH-VALUE. Exports detectados: UploadPage, function. Funções/classes detectadas: UploadPage, handleUpload. Dependências locais detectadas: @/components/ui/button, @/components/ui/card, @/components/ui/input, @/components/ui/label, @/hooks/use-toast, @/lib/utils. Dependências externas detectadas: lucide-react, next/navigation, react. Temas relevantes detectados: dashboard, sdr, upload. Indícios de framework/arquitetura: react/tsx, next-app-router, client-component, express, next-runtime.
