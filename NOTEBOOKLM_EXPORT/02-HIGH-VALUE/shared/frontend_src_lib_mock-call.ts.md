...
## Visão geral
- Caminho original: `frontend/src/lib/mock-call.ts`
- Domínio: **shared**
...
## Resumo factual
Este arquivo foi classificado como source-file no domínio shared. Criticidade: supporting. Prioridade: 02-HIGH-VALUE. Exports detectados: MOCK_CALL. Temas relevantes detectados: calls, dashboard, email, hubspot, sdr, team.
